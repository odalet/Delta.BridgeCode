...
{
    public class BaseAntlrSyntaxTree : BaseSyntaxTree
    {
        private class TreeUtils
        {
        ...
        public BaseAntlrSyntaxTree(Parser antlrParser, ParserRuleContext antlrInitialRule)
        {
            parser = antlrParser;
        ...
        public override void DumpTo(TextWriter writer)
        {
